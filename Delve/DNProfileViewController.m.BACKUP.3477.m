...
- (void)viewDidLoad
{
    ...
    arrayList = [[NSArray alloc] initWithObjects:@"Most commented",@"Most delved",@"Log Out", nil];
    
    // Create dropdown
<<<<<<< HEAD
    _tableViewDropDown = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, kRowHeight*[arrayList count]) style:UITableViewStylePlain];
=======
    _tableViewDropDown = [[UITableView alloc] initWithFrame:CGRectMake(0, -kDropDownTableHeight, self.view.frame.size.width, kDropDownTableHeight) style:UITableViewStylePlain];
>>>>>>> e6e2d088fe68088e74ac3ff08a72ef76118804c7
...
<<<<<<< HEAD
    _tableViewDropDown.backgroundColor = [UIColor whiteColor];
=======
...
>>>>>>> e6e2d088fe68088e74ac3ff08a72ef76118804c7
    ...
    UITapGestureRecognizer *gestureRecognizer=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(showDropdownList:)];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"openInWebview"]) {
        ...
        DNProfileCell* cell= [articleCells objectAtIndex:indexPath.row];
        DNArticleViewController *articleViewController = segue.destinationViewController;
        NSLog(@"LINK TO OPEN : %@",cell.articleLink);
...
- (void)showDropdownList:(id)sender
{
    ...
    if(_tableViewDropDown.hidden)
    {
        ...
        [UIView animateWithDuration:0.3f
                            ...
                            options: 0
                         animations:^{
                             _tableViewDropDown.frame = CGRectMake(0, 0, self.view.frame.size.width, kDropDownTableHeight);
                         }
    ...
    else
    {
        [UIView animateWithDuration:0.3f
                            ...
                            options: 0
                         animations:^{
                             _tableViewDropDown.frame = CGRectMake(0, -kDropDownTableHeight, self.view.frame.size.width, kDropDownTableHeight);
                         }
                         completion:^(BOOL finished){
                             _tableViewDropDown.hidden=YES;
                             maskView.hidden=YES;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(tableView.tag == kDropDownTag)
    {
        tableView.separatorColor = [UIColor colorWithRed:0.901 green:0.901 blue:0.909 alpha:1];
...
<<<<<<< HEAD
        ...
        UIView *bg = [[UIView alloc] initWithFrame:CGRectMake(0, -1, cell.contentView.frame.size.width, cell.contentView.frame.size.height)];
